...
import { A as ApplicationLogo } from "./ApplicationLogo-Ciywr56m.js";
...
function AuthenticatedLayout({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-gray-100", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "hidden space-x-8 sm:-my-px sm:ms-10 sm:flex", children: [
            ...
            /* @__PURE__ */ jsx(
              NavLink,
              {
                href: route("estate-type.index"),
                active: route().current(
                  "estate-type.index"
                ),
                children: "Tipovi Nekretnina"
              }
            ),
            /* @__PURE__ */ jsx(
              NavLink,
              {
                href: route("hashtag-group.index"),
                active: route().current(
                  "hashtag-group.index"
                ),
                children: "Hashtagovi"
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-1 pb-3 pt-2", children: [
              ...
              /* @__PURE__ */ jsx(
                ...
                {
                  href: route("estate-type.index"),
                  active: route().current("estate-type.index"),
                  children: "Tipovi nekretnina"
                }
              ),
              /* @__PURE__ */ jsx(
                ...
                {
                  href: route("hashtag-group.index"),
                  active: route().current("hashtag-group.index"),
                  children: "Hashtagovi"
                }
              ),
              /* @__PURE__ */ jsx(
                ...
                {
                  href: route("real-estate.index"),
                  active: route().current("real-estate.index"),
                  children: "Nekretnine"
                }
              ),
              /* @__PURE__ */ jsx(
    ...
    (flash == null ? void 0 : flash.message) && /* @__PURE__ */ jsx("div", { className: "p-4 mb-4 text-sm text-blue-800 bg-blue-100 border border-blue-300 rounded-lg fadeOut", children: /* @__PURE__ */ jsx("p", { children: flash.message }) }),
