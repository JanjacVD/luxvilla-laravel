...
const Create = () => {
  ...
  return /* @__PURE__ */ jsx(AuthenticatedLayout, { header: "Kreiraj Groupu", children: /* @__PURE__ */ jsx("div", { className: "p-8", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, children: [
    /* @__PURE__ */ jsx(
      TranslatableInput,
      {
        label: "Naziv",
