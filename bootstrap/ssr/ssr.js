...
const heroDescription$1 = "Agency for you.";
const featured$1 = "Featured";
const terms$1 = "Terms of Service";
const imageDescriptions$1 = {
  first: "Luxurious villa exterior"
};
const gallery$1 = "Real Estates for sale Gallery";
const clearAll$1 = "Clear All";
const estateCard$1 = {
  details: "Estate details",
  name: "Estate name",
  area: "Estate area size",
  vat1: "The agency commission amounts to",
  vat2: "from the achieved purchase price.",
  vat: "VAT",
  price: "Estate price",
  location: "Estate location",
  parking: "Parking Spaces",
  rooms: "Rooms",
  dateBuilt: "Year built",
  dateRenovated: "Year renovated",
  basicDetails: "Basic Details",
  features: "Features"
};
const estateFilter$1 = {
  typeDefault: "All Types",
  countyDefault: "All Counties",
  cityDefault: "All Cities",
  areaDefault: "All Areas",
  type: "Estate Type",
  county: "Estate County",
  city: "Estate City",
  area: "Estate city area",
  search: "Search",
...
const footer$1 = {
  ...
  workHours: "Operating hours: Monday - Friday: 08:00 - 16:00h",
...
const estateDetails$1 = "Estate Details";
const saleIn$1 = "Estates in";
const goToHome$1 = "Go to homepage";
const salesIn$1 = "Sale of";
const sale$1 = "Sale";
const allEstates$1 = "All types of Estate";
const exploreEstates$1 = "Explore estates in {{name}}";
const exploreEstatesGeneral$1 = "Explore estates in Croatia";
const meta$1 = {
  developedBy: "Developed by Valentino Digital Solutions",
  homepage: {
    title: "Real Estate Agency",
    ogDesc: "Browse a wide selection of properties including ",
    desc: "Discover the best properties for sale.",
    discoverIn: "Discover estates in "
  }
};
const keywords$1 = {
  homepage: "Real Estate Agency Croatia, Real Estate Agency Vodice"
};
const sort$1 = {
  sort: "Sort by",
  price: "Price",
  dateAsc: "Oldest",
  dateDesc: "Newest",
  priceAsc: "Smaller Price",
  priceDesc: "Larger Price"
};
const contact$1 = {
  title: "Intereseted? Get in touch",
  email: "Email",
  name: "Name",
  phone: "Phone number",
  msg: "Message",
  ...
  line: "Thank you for your inquiry. We will reach out to you as soon as possible",
  end: "Best regards, Lux Villa!",
  regard: "Hello"
};
const en = {
  heroDescription: heroDescription$1,
  featured: featured$1,
  "new": "Newly Available",
  terms: terms$1,
  imageDescriptions: imageDescriptions$1,
  gallery: gallery$1,
  clearAll: clearAll$1,
  estateCard: estateCard$1,
  estateFilter: estateFilter$1,
  description: description$1,
  common: common$1,
  footer: footer$1,
  estateDetails: estateDetails$1,
  saleIn: saleIn$1,
  goToHome: goToHome$1,
  salesIn: salesIn$1,
  sale: sale$1,
  allEstates: allEstates$1,
  exploreEstates: exploreEstates$1,
  exploreEstatesGeneral: exploreEstatesGeneral$1,
  meta: meta$1,
  keywords: keywords$1,
  sort: sort$1,
  contact: contact$1
};
const heroDescription = "Agencija za vas.";
const featured = "Istaknuto";
const terms = "Opći uvjeti poslovanja";
const imageDescriptions = {
  first: "Luksuzna vanjština vile"
};
const gallery = "Galerija nekretnina na prodaju";
const clearAll = "Poništi sve";
const estateCard = {
  details: "Detalji nekretnine",
  name: "Naziv nekretnine",
  area: "Površina nekretnine",
  vat1: "Agencijska provizija iznosi",
  vat2: "od postignute kupoprodajne cijene.",
  vat: "PDV",
  price: "Cijena nekretnine",
  location: "Lokacija nekretnine",
  parking: "Parkirna mjesta",
  rooms: "Broj soba",
  dateBuilt: "Godina izgradnje",
  dateRenovated: "Godina posljednje renovacije",
  basicDetails: "Osnovni detalji",
  features: "Značajke"
};
const estateFilter = {
  typeDefault: "Sve vrste",
  countyDefault: "Sve županije",
  cityDefault: "Svi gradovi",
  areaDefault: "Sva naselja",
  type: "Vrsta",
  county: "Županija",
  city: "Grad",
  area: "Naselje",
...
const footer = {
  ...
  workHours: "Radno vrijeme: Pon - Pet: 08:00 - 16:00h",
  address: "Adresa ureda",
...
const estateDetails = "Detalji nekretnine";
const saleIn = "Nekretnine u";
const goToHome = "Povratak na početnu stranicu";
const salesIn = "Prodaja";
const sale = "Prodaja";
const allEstates = "Sve vrste nekretnina";
const exploreEstates = "Istražite nekretinie u području: {{name}}";
const exploreEstatesGeneral = "Istražite nekretnine u Hrvatskoj";
const meta = {
  developedBy: "Developed by Valentino Digital Solutions",
  homepage: {
    title: "Agencija za nekretnine",
    ogDesc: "Pretražite širok izbor nekretnina uključujući ",
    desc: "Otkrijte najbolje nekretnine na prodaju.",
    discoverIn: "Otkrijte nekretnine u "
  }
};
const keywords = {
  homepage: "Agencija za nekretnine Hrvatska, Agencija za nekretnine Vodice"
};
const sort = {
  sort: "Sortiraj po",
  price: "Cijena",
  dateAsc: "Najstarije",
  dateDesc: "Najnovije",
  priceAsc: "Niža cijena",
  priceDesc: "Viša cijena"
};
const contact = {
  title: "Zainteresirani? Kontaktirajte nas",
  email: "E-mail",
  name: "Ime",
  phone: "Broj telefona",
  msg: "Poruka",
  submit: "Pošalji",
  emailSent: "E-mail uspješno poslan",
  sendError: "Nije moguće poslati E-mail",
  line: "Hvala na vašem upitu. Javit ćemo vam se u najkraćem mogućem roku",
  end: "S poštovanjem, Lux Villa!",
  regard: "Pozdrav"
};
const hr = {
  heroDescription,
...
createServer(
  (page) => createInertiaApp({
    ...
    resolve: (name) => resolvePageComponent(
      `./Pages/${name}.tsx`,
      /* @__PURE__ */ Object.assign({ "./Pages/Auth/ConfirmPassword.tsx": () => import("./assets/ConfirmPassword-i0sHqG0r.js"), "./Pages/Auth/ForgotPassword.tsx": () => import("./assets/ForgotPassword-NGQOJUTN.js"), "./Pages/Auth/Login.tsx": () => import("./assets/Login-C6yJVUIT.js"), "./Pages/Auth/Register.tsx": () => import("./assets/Register-DaeTJWAu.js"), "./Pages/Auth/ResetPassword.tsx": () => import("./assets/ResetPassword-_MZg2nl1.js"), "./Pages/Auth/VerifyEmail.tsx": () => import("./assets/VerifyEmail-Dk8DS-Bq.js"), "./Pages/Contacts/Index.tsx": () => import("./assets/Index-C1eFLwGF.js"), "./Pages/Contacts/hooks/ColumnDefinitions.tsx": () => import("./assets/ColumnDefinitions-BQpWuBej.js"), "./Pages/Dashboard.tsx": () => import("./assets/Dashboard-DIgzaq6u.js"), "./Pages/Estate/Create.tsx": () => import("./assets/Create-DnExqgsn.js"), "./Pages/Estate/Edit.tsx": () => import("./assets/Edit-BigdsAMC.js"), "./Pages/Estate/Index.tsx": () => import("./assets/Index-hqvo3NLw.js"), "./Pages/Estate/Show.tsx": () => import("./assets/Show-Dpc0Dvzg.js"), "./Pages/Estate/hooks/ColumnDefinitions.tsx": () => import("./assets/ColumnDefinitions-Mda7N6LT.js"), "./Pages/EstateType/Create.tsx": () => import("./assets/Create-BtY_Tucd.js"), "./Pages/EstateType/Edit.tsx": () => import("./assets/Edit-BlcjLEcw.js"), "./Pages/EstateType/Index.tsx": () => import("./assets/Index-DEWUG-nJ.js"), "./Pages/EstateType/hooks/ColumnDefinitions.tsx": () => import("./assets/ColumnDefinitions-CPfZhTZ5.js"), "./Pages/Guest/EstateList.tsx": () => import("./assets/EstateList-XHhD2P79.js"), "./Pages/Guest/EstateView.tsx": () => import("./assets/EstateView-B0sl9cOl.js"), "./Pages/Guest/Homepage.tsx": () => import("./assets/Homepage-BccQJXhW.js"), "./Pages/Guest/TermsOfService.tsx": () => import("./assets/TermsOfService-CfNVlXNj.js"), "./Pages/Hashtag/Create.tsx": () => import("./assets/Create-BCqj6kdt.js"), "./Pages/Hashtag/Edit.tsx": () => import("./assets/Edit-wkKdF1Bl.js"), "./Pages/HashtagGroup/Create.tsx": () => import("./assets/Create-siCGe-V4.js"), "./Pages/HashtagGroup/Edit.tsx": () => import("./assets/Edit-BnyM04jx.js"), "./Pages/HashtagGroup/Index.tsx": () => import("./assets/Index-Bnf2pmZQ.js"), "./Pages/HashtagGroup/components/HashtagTable.tsx": () => import("./assets/HashtagTable-CmBSAZtH.js"), "./Pages/HashtagGroup/hooks/ColumnDefinitions.tsx": () => import("./assets/ColumnDefinitions-BlwmFOoS.js"), "./Pages/HashtagGroup/hooks/SubtableColumnDefinitions.tsx": () => import("./assets/SubtableColumnDefinitions-DA13n37w.js"), "./Pages/Profile/Edit.tsx": () => import("./assets/Edit-xl3dqKG1.js"), "./Pages/Profile/Partials/DeleteUserForm.tsx": () => import("./assets/DeleteUserForm-D-7MHk8r.js"), "./Pages/Profile/Partials/UpdatePasswordForm.tsx": () => import("./assets/UpdatePasswordForm-IKn-Z_Zy.js"), "./Pages/Profile/Partials/UpdateProfileInformationForm.tsx": () => import("./assets/UpdateProfileInformationForm-B8jWyUQ7.js") })
    ),
    setup: ({ App, props }) => {
